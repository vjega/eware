...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            <button class="btn btn-inverse" data-toggle="modal" id="showUomPop">New SRV</button>
            <button class="btn btn-inverse" data-toggle="modal" id="editUomPop">Edit Selected SRV</button>
            <button class="btn btn-inverse" data-toggle="modal" id="delUom">Delete Selected SRV</button>
        </div>
    </div>
@stop
