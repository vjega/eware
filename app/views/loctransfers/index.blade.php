...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading"><h3>Location Transfer - Movement</h3></div>
        <div class="panel-body">
            <table id="locationTransferList"></table>
            <div id="locationTransferPager"></div>
        </div>
        <div class="panel-footer">
            <button class="btn btn-inverse" data-toggle="modal" id="showUomPop">New Location Transfer</button>
            <button class="btn btn-inverse" data-toggle="modal" id="editUomPop">Edit Selected Location Transfer</button>
            <button class="btn btn-inverse" data-toggle="modal" id="delUom">Delete Selected Location Transfer</button>
        </div>
    </div>
@stop
...
jQuery("#locationTransferList").jqGrid({ 
    ...
    height: 375,
    width: panelWidth,
    colNames:['<input type="checkbox"/>','Client Code','Movement Date','Movement number','Remarks','Reference No'],
    colModel:[
        {name:'select'},
		{name:'client_code'},
		{name:'movement_date'},
