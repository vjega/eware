...
@section('content')
	<div class="panel panel-default">
		<div class="panel-heading">Zone List</div>
		<div class="panel-body">
			<table id="locationList"></table>
			<div id="locationPager"></div>
		</div>
		<div class="panel-footer">
			<button class="btn btn-default" data-toggle="modal" data-target="#addLocation">New Zone</button>
		</div>
	</div>
@stop
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add/Edit Zone</h4>
      </div>
